...
IPAddress TCP_IP ( 192, 168, 1, 42 );				// Configure your static ip-address here
byte TCP_MAC[] = { 0x02, 0xDE, 0xAD, 0xFF, 0x42, 0x42 };	// Mac-address - You should change this! see note *2 above!
